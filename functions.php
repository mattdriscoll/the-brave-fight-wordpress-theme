...
function the_brave_fight_setup() {
	/*
		...
		* If you're building a theme based on The Brave Fight, use a find and replace
		* to change 'the-brave-fight' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'the-brave-fight', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'the-brave-fight' ),
		)
	);
...
function the_brave_fight_scripts() {
	wp_enqueue_style( 'the-brave-fight-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'the-brave-fight-style', 'rtl', 'replace' );
